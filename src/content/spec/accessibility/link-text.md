...
summary: "Every link's text must describe where it goes. 'Click here' and 'read more' fail screen-reader users who scan a page by jumping from link to link."
status: required
order: 90
appliesTo: [all]
relatedSlugs: [empty-links-buttons, semantic-html]
updated: "2026-05-29"
sources:
