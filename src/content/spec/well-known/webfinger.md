...
slug: webfinger
category: well-known
summary: "WebFinger (RFC 7033) resolves an account identifier such as acct:user@example.com to a set of links. The Fediverse uses it to discover ActivityPub actors."
status: optional
order: 40
appliesTo: [all]
