...
slug: indexnow
category: seo
summary: "An open protocol for telling participating search engines that a URL has changed. One HTTP request pushes Bing, Yandex, Naver, and Seznam to recrawl — Google does not participate."
status: optional
order: 120
appliesTo: [all]
